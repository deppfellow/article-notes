...
function rollCall(names) {
    ...
    function logName() {
        if (indexCounter === names.length) {
            console.log("Everyone accounted for");
            return
        };

        console.log(names[indexCounter]);
        indexCounter++;
    };
...
function cycleIterator(array) {
    ...
    function logCycle() {
        ...
        let output = array[idx % array.length];
        idx++;
...
function defineFirstArg(func, arg) {
    // // Personal work
    // function processCallback(num) {
    //     return func(arg, num);
    // }
    function firstArg(...params) { return func(arg, ...params) }
